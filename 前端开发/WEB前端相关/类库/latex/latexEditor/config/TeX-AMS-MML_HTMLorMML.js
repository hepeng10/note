        ...
        while (c) {
            ...
            if (c) {
                do {
                    d = c;
                    c = c.nextSibling
                } while (c && this.ignoreTags[c.nodeName.toLowerCase()] != null);if (!c || c.nodeName !== "#text") {
                    if (!a) {
...
(function(f, o, q, e, r) {
    ...
    g.ENTRY = g.ITEM.Subclass({
        ...
        MoveVertical: function(u, E, w) {
            ...
            do {
                B = g.Mod(w(B), A)
            } while (D[B].hidden || !v[B].role || v[B].role === "separator");this.Deactivate(E);
            D[B].Activate(u, v[B])
        },
        Up: function(v, u) {
    ...
    var a = MathJax.Object.Subclass({
        ...
        Prime: function(o) {
            ...
            do {
                ...
                this.i++,
                o = this.GetNext()
            } while (o === "'" || o === this.SMARTQUOTE);m = ["", "\u2032", "\u2033", "\u2034", "\u2057"][m.length] || m;
        ...
        getTag: function() {
            ...
            if (document.getElementById(k.id) || g.IDs[k.id] || g.eqIDs[k.id]) {
                ...
                do {
                    l++;
                    j = k.id + "_" + l
                } while (document.getElementById(j) || g.IDs[j] || g.eqIDs[j]);k.id = j;
                if (m.label) {
...
(function(i, b, e, g) {
    ...
    g.Augment({
        ...
        getJaxFromMath: function(n) {
            ...
            do {
                n = n.nextSibling
            } while (n && n.nodeName.toLowerCase() !== "script");return b.getJaxFor(n)
        },
