(function() {
    var h = {}
      , mt = {}
      , c = {
        id: "ae71cd2b84fabcb4d9ac846c9425dee3",
        dm: ["latex.91maths.com"],
        js: "tongji.baidu.com/hm-web/js/",
        etrk: [],
        cetrk: [],
        cptrk: [],
        icon: '',
        ctrk: ["%5b%22http%3a%5c%2f%5c%2flatex.91maths.com%22%5d"],
        nv: -1,
        vdur: 1800000,
        age: 31536000000,
        rec: 0,
    ...
    (function() {
            ...
            try {
                ...
                for (a = 0; d && a < f.length; ) {
                    ...
                    if (!("html" === l || "body" === l)) {
                        ...
                        for (q = 0; q < d.childNodes.length; q++)
                            1 === d.childNodes[q].nodeType && d.childNodes[q].nodeName.toLowerCase() === l && e.push(d.childNodes[q]);
                        if (!e[b])
                            return x;
                        d = e[b]
                    }
        ...
        mt.f.Fa = function(a, f) {
            ...
            for (; a.parentNode != x; ) {
                ...
                if ((n = "" !== a.id) && f) {
                    ...
                    b.push(n)),
                    d.unshift(encodeURIComponent(String(a.nodeName).toLowerCase()) + (1 < e ? "[" + l + "]" : ""));
                a = a.parentNode
            }
            b.push(d.join(">"));
            return b
        ...
        mt.f.Xa = function(a) {
            var f;
            for (f = "A"; (a = a.parentNode) && 1 == a.nodeType; )
                if (a.tagName == f)
                    return a;
            return x
        }
        ...
        mt.f.Ya = function(a) {
            ...
            return {
                top: f.top + (window.pageYOffset || d.scrollTop) - (d.clientTop || 0),
        ...
        mt.f.getAttribute = function(a, f) {
            ...
            if (!d && a.attributes && a.attributes.length)
                for (var b = a.attributes, e = b.length, l = 0; l < e; l++)
                    b[l].nodeName === f && (d = b[l].nodeValue);
            return d
        }
        ;
        mt.f.V = function(a) {
        ...
        mt.f.U = function(g, f) {
            var d;
            a.H(g) && 0 === String(g).indexOf("!HMCQ!") ? (d = String(g),
            d = b.m(document.location.href, d.substring(6, d.length))) : a.H(g) || (d = mt.f.V(g),
            "input" === d && f && ("button" === g.type || "submit" === g.type) ? d = a.trim(g.value) || "" : "input" === d && !f && "password" !== g.type ? d = a.trim(g.value) || "" : "img" === d ? (d = mt.f.getAttribute,
            d = d(g, "alt") || d(g, "title") || d(g, "src")) : d = "body" === d || "html" === d ? ["(hm-default-content-for-", d, ")"].join("") : mt.f.bc(g));
                ...
                (function() {
                    if (!d)
                        ...
                        "complete" === document.readyState)
                            ...
                            document.addEventListener("DOMContentLoaded", e, y),
                            window.addEventListener("load", a, y);
        ...
        return function(f) {
            ...
            default:
                ...
                if (f instanceof Date)
                    return '"' + f.getFullYear() + "-" + b(f.getMonth() + 1) + "-" + b(f.getDate()) + "T" + b(f.getHours()) + ":" + b(f.getMinutes()) + ":" + b(f.getSeconds()) + '"';
                e = ["{"];
                l = mt.s.stringify;
                for (g in f)
    ...
    mt.localStorage.set = function(a, b, g) {
        ...
        try {
            ...
            window.localStorage.setItem(a, b)) : mt.localStorage.xa() && (mt.localStorage.l.expires = f.toUTCString(),
    ...
    (function() {
        var a = {
            ...
            K: function(a, g) {
                this.F[a] = this.F[a] || [];
                for (var f = this.F[a].length, d = 0; d < f; d++)
                    this.F[a][d](g)
            }
        };
        return h.z = a
            ...
            S: function(f, d) {
                ...
                if (!a.d(b, "Undefined")) {
                    ...
                    if (a.d(b, "Object")) {
                        var e = [], l;
                        for (l in b)
                            b.hasOwnProperty(l) && g.eb(l, d) && (e = e.concat(b[l]));
                        return e
                    }
                }
            }
          ...
          , f = {
            ...
            la: function() {
                for (var a = 0, b = c.dm.length; a < b; a++) {
                    var e = c.dm[a];
                    if (-1 < e.indexOf("/") && f.qa(document.location.href, e))
                        return e.replace(/^[^/]+(\/.*)/, "$1") + "/"
                }
                return "/"
            }
    ...
    (function() {
        var a = mt.lang
          ...
          , l = {
            ...
            Ga: function() {
                for (var a = {}, b, d = u.length - 1; 0 <= d; d--) {
                    b = f[u[d]];
                    for (var p in b)
            ...
            o: function(b) {
                b !== t && ("userId" === b && a.d(f.user, "Object") ? (delete f.user.uid_,
                l.Ka()) : "user" === b && a.d(f.user, "Object") ? (b = f.user.uid_,
                f.user = b === t ? {} : {
                    uid_: b
                },
                l.Ka()) : f[b] !== t && (f[b] = {}))
            ...
            qc: function(a, b, d) {
                var p = v
                  , e = f[a];
                if (256 < encodeURIComponent(String(b)).length || 256 < encodeURIComponent(String(d)).length)
                    p = y;
                else {
                    var k = e[b];
                    e[b] = {
                    ...
                    a = l.O(l.B(a));
                    2048 < encodeURIComponent(a).length && (k !== t ? e[b] = k : delete e[b],
                    p = y)
                }
                return p
            },
            O: function(a) {
                var b = [], f, d;
                for (d in a)
                    a.hasOwnProperty(d) && (f = [d, a[d].value],
                    (1 === a[d].scope || 2 === a[d].scope) && f.push(a[d].scope),
                    b.push(f.join("*")));
                return b.join("!")
            },
            $a: function(a) {
    ...
    (function() {
        ...
        if (b.isArray(c.cptrk) && 0 < c.cptrk.length) {
            var e = {
                ...
                init: function() {
                    for (var a, d = f.S(c.cptrk) || [], q = 0; q < d.length; q++)
                        ...
                        a.a !== t && b.d(a.a, "Object")) {
                            a = a.a;
                            for (var g in a)
                                a.hasOwnProperty(g) && (e.va[g] = String(a[g]))
                        }
                },
                gb: function() {
                    var b, f, d;
                    for (d in e.va)
                        if (e.va.hasOwnProperty(d) && e.hb[d] === t && (b = e.va[d],
                        b = a.Da(b)))
                            f = f === t ? {} : f,
                            f[d] = a.U(b, y),
                            e.hb[d] = v;
                ...
                mc: function() {
                    "MutationObserver"in window ? (new MutationObserver(e.Ha)).observe(document.body, {
                        childList: v,
                        subtree: v
    ...
    (function() {
        var a = mt.lang
          ...
          , f = {
            ka: function(a, u) {
                return function(e) {
                    ...
                    if (l) {
                        ...
                        if (q && q === e)
                            l.removeAttribute(a.wa);
                        else if (0 < n.length && (l = b.Zb(l)) && l.length)
                            if (n = l.length,
                            q = l[l.length - 1],
                            1E4 > n * q.split(">").length)
                                for (q = 0; q < n; q++)
                                    f.ob(a, l[q]);
                            else
                                f.ob(a, q)
            ...
            ob: function(b, f) {
                for (var e = {}, g = String(f).split(">").length, n = 0; n < g; n++)
                    e[f] = "",
                    f = f.substring(0, f.lastIndexOf(">"));
                b && (a.d(b, "Object") && b.Ua) && b.Ua(e)
            },
            vc: function(a, b) {
                return function(f) {
        ...
        var a = mt.f
          ...
          , n = {
            ...
            Tb: function(a, b) {
                a = String(a);
                if (0 < a.indexOf("*")) {
                    var f = RegExp("^" + a.replace(/\[/g, "\\[").replace(/\]/g, "\\]").replace(/\*/, "\\d+") + "$"), d;
                    for (d in b)
                        if (b.hasOwnProperty(d) && f.test(d))
                            return d;
                    return x
                }
            ...
            Ob: function(b, d) {
                var e = a.Da(d)
                  , g = f.Qa;
                e && (c.aet && c.aet.length ? (b.ei_ = a.getAttribute(e, g.id) || a.getAttribute(e, "id") || "",
                b.ec_ = a.getAttribute(e, g.ha) || a.getAttribute(e, "class") || "",
                b.ex_ = a.getAttribute(e, g.ga) || a.ma(e),
                b.en_ = a.getAttribute(e, g.content) || a.U(e, v),
                b.et_ = a.getAttribute(e, g.ua) || a.V(e),
                b.el_ = a.getAttribute(e, g.link) || a.getAttribute(e, "href") || "") : (b.ex_ = a.getAttribute(e, g.ga) || a.ma(e),
                b.en_ = a.getAttribute(e, g.content) || a.U(e, v)));
                return b
            },
            $b: function(b, f) {
    ...
    (function() {
        var a = mt.f
          ...
          , l = {
            ub: function() {
                c.ctrk && 0 < c.ctrk.length && (g.e(document, "mouseup", l.Eb()),
                g.e(window, "unload", function() {
                    l.sa()
                }),
            ...
            Eb: function() {
                return function(a) {
                    if (u.S(c.ctrk, v) && (a = l.Pb(a),
                    "" !== a)) {
                        var b = (d.ra + "//" + d.Ma + "?" + h.c.nb().replace(/ep=[^&]*/, "ep=" + encodeURIComponent(a))).length;
                        b + (d.ca + "").length > d.P || (b + encodeURIComponent(e.join("!") + (e.length ? "!" : "")).length + (d.ca + "").length > d.P && l.sa(),
                        e.push(a),
            ...
            Pb: function(e) {
                ...
                var p;
                f.na ? (p = Math.max(document.documentElement.scrollTop, document.body.scrollTop),
                s = Math.max(document.documentElement.scrollLeft, document.body.scrollLeft),
                s = e.clientX + s,
                p = e.clientY + p) : (s = e.pageX,
                p = e.pageY);
                e = l.Xb(e, g, s, p);
                ...
                r.push(e.fa);
                r.push(e.X);
                (g = "a" === (g.tagName || "").toLowerCase() ? g : a.Xa(g)) ? (r.push("a"),
                r.push(b.h(encodeURIComponent(g.href)))) : r.push("b");
                return r.join("*")
            },
            Xb: function(d, e, g, p) {
                d = a.ma(e);
                var r = 0
                  ...
                  , m = 0
                  , w = 0;
                if (e && (r = e.offsetWidth || e.clientWidth,
                k = e.offsetHeight || e.clientHeight,
                w = a.Ya(e),
                m = w.left,
                w = w.top,
                b.d(e.getBBox, "Function") && (k = e.getBBox(),
                r = k.width,
                k = k.height),
                "html" === (e.tagName || "").toLowerCase()))
                    r = Math.max(r, e.clientWidth),
                    k = Math.max(k, e.clientHeight);
                return {
    ...
    (function() {
        var a = mt.lang
          ...
          , s = {
            ...
            Ea: function(e, g) {
                ...
                "click" === g.type ? m = f.na ? g.clientY + Math.max(document.documentElement.scrollTop, document.body.scrollTop) : g.pageY : "touchend" === g.type && (g.fb && g.fb.changedTouches) && (m = g.fb.changedTouches[0].pageY);
                k.Ec = m;
                m = this.Sb(g);
                k.ba = m.ba || 0;
                k.da = m.da || 0;
            ...
            Sb: function(e) {
                ...
                var w = m = 0
                  , z = 0
                  , A = 0;
                if (d && (m = d.offsetWidth || d.clientWidth,
                w = d.offsetHeight || d.clientHeight,
                A = b.Ya(d),
                z = A.left,
                A = A.top,
                a.d(d.getBBox, "Function") && (w = d.getBBox(),
                m = w.width,
                w = w.height),
                "html" === (d.tagName || "").toLowerCase()))
                    m = Math.max(m, d.clientWidth),
                    w = Math.max(w, d.clientHeight);
                return {
            ...
            ya: function(b) {
                var f = a.h;
                b = [+new Date - (h.c.$ !== t ? h.c.$ : n), f(b.id), f(b.ha), f(b.ua), f(b.ga), f(b.link), f(b.content), b.type, b.Ec, b.ba, b.da, b.fa, b.X, b.Oa].join("*");
                s.za(b);
                a.d(this.ea(), "Function") && this.ea()()
            },
            za: function(a) {
                a.length > d.P || (encodeURIComponent(q.join("!") + a).length > d.P && (s.w(q.join("!")),
                q = []),
                q.push(a))
            },
            w: function(a) {
        ...
        a.H(c.aet) && "" !== c.aet && u.e("pv-b", function() {
            ...
            "ontouchend"in document && g.e(window, "touchend", s.ka());
    ...
    (function() {
        var a = mt.lang
          ...
          , q = {
            Kb: function() {
                return function() {
                    h.c && (h.c.Y && c.aet && c.aet.length) && (window.clearTimeout(l),
            ...
            za: function(a) {
                if (encodeURIComponent(e.join("!") + a).length > f.P || 3 < e.length)
                    q.w(e.join("!")),
                    e = [];
                e.push(a)
            },
    ...
    (function() {
        ...
        function f(a) {
            if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window))
                q = "focus" == a.type || "focusin" == a.type ? v : y,
                b()
        }
        var d = mt.event, u = h.z, e = v, l = v, n = v, q = v, s = +new Date, p = s, r = 0, k = v, m = g("visibilityState"), w = g("hidden"), z;
        b();
        (function() {
            ...
            "object" == typeof document.onfocusin ? (d.e(document, "focusin", f),
            d.e(document, "focusout", f)) : (d.e(window, "focus", f),
            d.e(window, "blur", f))
        }
        )();
        h.Ba = {
    ...
    (function() {
        ...
        var g = mt.url
          ...
          , k = {
            ...
            Mb: function() {
                if (0 < k.aa.length)
                    for (var a = 0, b = k.aa.length; a < b; a++)
                        k.La(k.aa[a]);
                k.aa = x
            },
            La: function(a) {
                var b = a[0];
                if (k.hasOwnProperty(b) && f.d(k[b], "Function"))
                    k[b](a)
            },
            ...
            _trackPageview: function(a) {
                ...
                h.c.Ia ? (h.c.b.nv = 0,
                h.c.b.st = 4) : h.c.Ia = v,
                k.Ja || (h.c.b.su = h.c.b.u || document.location.href),
                h.c.b.u = e.protocol + "//" + document.location.host + a[1],
                h.c.b.p = r(p.B("pageview")),
                h.c.i(),
                h.c.b.p = "",
                h.c.$ = +new Date,
                p.o("pageview"))
            ...
            _trackEvent: function(a) {
                ...
                h.c.b.st = 4,
                h.c.b.et = 4,
                h.c.b.ep = f.h(a[1]) + "*" + f.h(a[2]) + (a[3] ? "*" + f.h(a[3]) : "") + (a[4] ? "*" + f.h(a[4]) : ""),
                h.c.b.p = r(p.Ga()),
                h.c.i(),
                h.c.b.p = "")
            },
            _setCustomVar: function(a) {
                if (!(4 > a.length)) {
                    ...
                    if (0 < b && 6 > b && 0 < e && 4 > e) {
                        k.ta++;
                        for (var d = (h.c.b.cv || "*").split("!"), g = d.length; g < b - 1; g++)
                            d.push("*");
                        d[b - 1] = e + "*" + f.h(a[2]) + "*" + f.h(a[3]);
                        h.c.b.cv = d.join("!");
            ...
            _setReferrerOverride: function(a) {
                1 < a.length && (a = a[1],
                f.d(a, "String") ? (h.c.b.su = "/" === a.charAt(0) ? e.protocol + "//" + window.location.host + a : a,
                k.Ja = v) : k.Ja = y)
            },
            ...
            _setAutoEventTrackingProperty: function(a) {
                a = a[1];
                f.d(a, "Object") && p.setProperty("autoEventTracking", a)
            },
            ...
            _providePlugin: function(a) {
                if (1 < a.length) {
                    var b = window._hmt
                      , d = a[1];
                    a = a[2];
                    if (f.G(e.ib, d) && f.d(a, "Function") && (b.plugins = b.plugins || {},
                    b.I = b.I || {},
                    b.plugins[d] = a,
                    b.C = b.C || [],
                    a = b.C.slice(),
                    d && a.length && a[0][1] === d))
                        for (var g = 0, k = a.length; g < k; g++) {
                            var l = a[g][2] || {};
                            if (b.plugins[d] && !b.I[d])
                                b.I[d] = new b.plugins[d](l),
                                b.C.shift();
                            else
                                break
                        }
    ...
    (function() {
        function a() {
            ...
            this.bb = this.ab = v,
            this.Y = k.Y,
            this.Ta = d.H(c.aet) && 0 < c.aet.length ? c.aet.split(",") : "",
            this.Ia = y,
            this.init())
        }
        var b = mt.url
        ...
        a.prototype = {
            ...
            la: function() {
                for (var a = 0, b = c.dm.length; a < b; a++) {
                    var e = c.dm[a];
                    if (-1 < e.indexOf("/") && this.qa(document.location.href, e))
                        return e.replace(/^[^/]+(\/.*)/, "$1") + "/"
                }
                return "/"
            },
            ac: function() {
                ...
                var a = y;
                this.oa(document.referrer) && this.oa(document.location.href) ? a = v : (a = b.L(document.referrer),
                a = this.Z(a || "", document.location.hostname));
            ...
            Bc: function() {
                ...
                if (g = s.getData("Hm_lvt_" + c.id)) {
                    ...
                    d = "",
                    f = 1;
                this.pc() ? (s.setData("Hm_lvt_" + c.id, g, c.age),
                s.setData("Hm_lpvt_" + c.id, k.J),
                e = u.rc(this.T(), this.la())) : this.Nb();
                if (0 === c.nv && this.oa(document.location.href) && ("" === document.referrer || this.oa(document.referrer)))
                    a = 0,
                    b = 4;
                this.b.nv = a;
                this.b.st = b;
            ...
            pc: function() {
                ...
                return !d.G("sjh.baidu.com isite.baidu.com ls.wejianzhan.com bs.wejianzhan.com product.weijianzhan.com qianhu.weijianzhan.com aisite.wejianzhan.com".split(" "), a)
            },
            Nb: function() {
            ...
            Cc: function() {
                ...
                this.b.cw = b.m(a, k.hc) || b.m(a, k.Jc) || "";
            ...
            Db: function() {
                var a = document.location.hash.substring(1)
                  , d = RegExp(c.id)
                  , e = b.L(document.referrer) === k.rb ? 1 : 0
                  , f = b.m(a, "jn")
                  , g = /^select$/.test(f);
                a && (d.test(a) && e && g) && (this.b.rnd = Math.round(Math.random() * k.ca),
    ...
    (function() {
        ...
        if ("undefined" !== typeof h.c && (c.med || (!a.na || 7 < a.Wb()) && c.cvcc)) {
            var d, u, e, l, n = function(a) {
                ...
                for (var d in a)
                    if (a.hasOwnProperty(d) && b.call(a, d, a[d]) === y)
                        return y
            }, s = function(a, g) {
                var k = {};
                k.n = d;
                ...
                if (g) {
                    var l = g.getAttribute("href")
                      ...
                      , p = g.getAttribute("id") || "";
                    e.test(l) ? (k.sn = "mediate",
                    k.snv = l) : b.d(n, "String") && e.test(n) && (k.sn = "wrap",
                    k.snv = n);
                    k.id = p
                }
                h.c.b.et = 86;
            ...
            if (c.med)
                u = "/zoosnet",
                d = "swt",
                e = /swt|zixun|call|chat|zoos|business|talk|kefu|openkf|online|\/LR\/Chatpre\.aspx/i,
                l = {
                    click: function() {
                        for (var a = [], b = n(document.getElementsByTagName("a")), b = [].concat.apply(b, n(document.getElementsByTagName("area"))), b = [].concat.apply(b, n(document.getElementsByTagName("img"))), d, f, g = 0, k = b.length; g < k; g++)
                            d = b[g],
                            f = d.getAttribute("onclick"),
                            d = d.getAttribute("href"),
                            (e.test(f) || e.test(d)) && a.push(b[g]);
                        return a
                    }
                };
            else if (c.cvcc) {
                ...
                l = {
                    click: function() {
                        for (var a = [], b = n(document.getElementsByTagName("a")), b = [].concat.apply(b, n(document.getElementsByTagName("area"))), b = [].concat.apply(b, n(document.getElementsByTagName("img"))), d, f, g, k = 0, l = b.length; k < l; k++)
                            d = b[k],
                            e !== t ? (f = d.getAttribute("onclick"),
                            g = d.getAttribute("href"),
                            p ? (d = d.getAttribute("id"),
                            (e.test(f) || e.test(g) || p.test(d)) && a.push(b[k])) : (e.test(f) || e.test(g)) && a.push(b[k])) : p !== t && (d = d.getAttribute("id"),
                            p.test(d) && a.push(b[k]));
                        return a
                    }
                }
    ...
    (function() {
        ...
        if ("undefined" !== typeof h.c && b.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
            var d = {
                wb: function() {
                    for (var b = c.cvcf.length, e, f = 0; f < b; f++)
                        (e = a.Wa(decodeURIComponent(c.cvcf[f]))) && g.e(e, "click", d.Ca())
                },
                Ca: function() {
                    return function() {
                        h.c.b.et = 86;
    ...
    c.oc !== t && "1" === String(c.oc) && (window._hmt = window._hmt || [],
